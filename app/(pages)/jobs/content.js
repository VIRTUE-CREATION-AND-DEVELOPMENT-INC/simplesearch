export const jobsContent = {
  ...
  description:
    "A results template for API-backed jobs with source attribution, optional fields, and an empty state ready for unwired data.",
  section: {
    eyebrow: "Jobs",
    title: "Results will land here after the Rise API is connected.",
    description:
      "This route is reserved for searchable jobs from Rise / Joinrise. The template keeps the source visible and avoids invented company or salary data.",
    ...
    detailAction: "Open detail template",
    fields: [
